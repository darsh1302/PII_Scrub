...
from models.decision import Decision, DecisionSet, PolicyViolation
from models.entities import Entity, NormalizedEvent, severity_for
...
def test_audit_record_avoids_forbidden_field_names():
    ...
    from session.audit_sink import AuditSink
    ...
    from session.audit_sink import _assert_pii_free
