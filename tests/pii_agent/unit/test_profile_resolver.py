...
from pii_agent.core.profile_resolver import ProfileResolver, resolve_profile
from pii_agent.models.enums import Destination, ScrubAction
from pii_agent.profiles.schema import BASE_SECURITY_TYPES, ProfileValidationError
from pii_agent.utils.config import MIN_CHUNK_OVERLAP_CHARS
...
def custom_dir(tmp_path):
    ...
    from tests.paths import PROFILES_DIR
