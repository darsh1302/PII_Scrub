...
from utils.config import MAX_JSON_DEPTH
from utils.safe_parsers import (
    ParseRefused,
    parse_csv,
    parse_json,
    parse_jsonl,
...
def test_csv_excessive_field_count_is_refused():
    from utils.config import MAX_CSV_FIELDS
...
def test_csv_excessive_row_length_is_refused():
    from utils.config import MAX_CSV_ROW_CHARS
