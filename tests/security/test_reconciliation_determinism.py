...
from models.enums import ConfidenceSource, DetectorName, EntitySeverity
...
def test_no_unpermitted_overlaps_remain_in_output():
    ...
    from core.reconciler import _NESTING_PERMITTED
...
def test_duplicate_values_are_both_detected_and_both_survive():
    ...
    from core.profile_resolver import resolve_profile
    from core.reconciler import filter_by_profile
