...
def test_core_modules_import_no_llm_dependency():
    ...
    script = textwrap.dedent(
        """
        import sys
        import core.pipeline, core.policy, core.applier, core.verifier
        import core.detector, core.reconciler, core.chunker, core.file_source
        import core.profile_resolver, core.recognizers, core.injection_scan
