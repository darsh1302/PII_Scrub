...
from pii_agent.utils.config import Settings, detect_engine_versions
...
def check_presidio() -> ComponentHealth:
    try:
        from pii_agent.core.detector import get_analyzer
...
def check_spacy() -> ComponentHealth:
    from pii_agent.core.detector import DetectorUnavailable, get_spacy
...
def check_engine_versions() -> ComponentHealth:
    ...
    from pii_agent.core.detector import shared_nlp_failure
