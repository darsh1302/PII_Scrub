...
from pii_agent.models.enums import EntitySeverity, RefusalReason
...
def describe_security_findings(result: ProcessingResult) -> str | None:
    ...
    lines = [
        ...
        "pii_agent.agent. It had no effect — scrub actions are decided in code, not by "
...
def build_profile_catalog(profile_name: str) -> list[CatalogEntry]:
    ...
    from pii_agent.models.entities import severity_for
