...
from pii_agent.models.entities import Entity, severity_for
from pii_agent.models.enums import ConfidenceSource, DetectorName
from pii_agent.session.context import get_shared_engine
from pii_agent.utils.config import SPACY_MODEL_NAME, chunk_timeout_for
from pii_agent.utils.normalization import (
    NormalizationResult,
...
def _build_analyzer():
    ...
    from pii_agent.core.ai_recognizers import build_ai_recognizers
    from pii_agent.core.financial_recognizers import build_financial_recognizers
    from pii_agent.core.recognizers import build_security_recognizers
...
def detect_presidio(
    ...
    *,
    ...
    from pii_agent.core.ai_recognizers import ai_entity_types
    from pii_agent.core.financial_recognizers import financial_entity_types
    from pii_agent.core.recognizers import security_entity_types
